...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'theDecider.security.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'theDecider.security.UserRole'
grails.plugin.springsecurity.authority.className = 'theDecider.security.Role'
//TODO: change after turing test is finished
grails.plugin.springSecurity.successHandler.defaultTargetUrl = '${createLink(controller:"turingTest", action:"index")}'
